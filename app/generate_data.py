...
MODELS = ["ollama/llama3.2:1b","ollama/phi3", "openai/gpt-4o", "openai/gpt-4o-mini"]
...
def generate_synthetic_data(start_time, end_time):
    ...
    print(f"Start historical data generation for grafana from {start_time} to {end_time}")
...
if __name__ == '__main__':
    ...
    print("Starting live data generation ... Pres Ctrl + C to stop.")
    try:
        generate_live_data()
